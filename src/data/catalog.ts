...
export const products: Product[] = [
  {
    slug: 'divan-lento', name: 'Диван «Ленто»', sku: 'VAV-101', category: 'sofas-armchairs',
  ...
  {
    slug: 'kreslo-avia', name: 'Кресло «Авиа»', sku: 'VAV-102', category: 'sofas-armchairs',
  ...
  {
    slug: 'stol-orion', name: 'Обеденный стол «Орион»', sku: 'VAV-201', category: 'dining',
    status: 'in-stock', featured: true,
  ...
  {
    slug: 'stul-nora', name: 'Стул «Нора»', sku: 'VAV-202', category: 'dining',
  ...
  {
    slug: 'krovat-tessa', name: 'Кровать «Тесса»', sku: 'VAV-301', category: 'bedroom',
    status: 'made-to-order', featured: true,
  ...
  {
    slug: 'tumba-mira', name: 'Прикроватная тумба «Мира»', sku: 'VAV-302', category: 'bedroom',
    status: 'in-stock',
  ...
  {
    slug: 'gostinaya-aura', name: 'Композиция «Аура»', sku: 'VAV-401', category: 'living-room',
    status: 'made-to-order', featured: true,
  ...
  {
    slug: 'stolik-velo', name: 'Журнальный столик «Вело»', sku: 'VAV-402', category: 'living-room',
    status: 'in-stock',
  ...
  {
    slug: 'komod-arden', name: 'Комод «Арден»', sku: 'VAV-501', category: 'storage',
    status: 'in-stock', featured: true,
  ...
  {
    slug: 'vitrina-linea', name: 'Витрина «Линеа»', sku: 'VAV-502', category: 'storage',
    status: 'made-to-order',
  ...
  {
    slug: 'svetilnik-sfera', name: 'Подвесной светильник «Сфера»', sku: 'VAV-601', category: 'light-decor',
    status: 'in-stock', featured: true,
  ...
  {
    slug: 'lampa-elara', name: 'Настольная лампа «Элара»', sku: 'VAV-602', category: 'light-decor',
    status: 'made-to-order',
